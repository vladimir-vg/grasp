...
| [`grasp-dbsp-server`](crates/grasp-dbsp-server) | runs one grasp-dbsp program, serves it over a subset of Feldera's HTTP API, and reads Kafka topics into its tables |
